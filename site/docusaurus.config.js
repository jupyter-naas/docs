        ...
        copyright: `
          <div style="display: flex; flex-direction: column; align-items: center; gap: 1rem;">
            <div style="display: flex; gap: 1rem; align-items: center;">
              ...
              <a href="https://twitter.com/JupyterNaas" target="_blank" rel="noopener noreferrer" style="color: var(--ifm-footer-link-color); transition: color 0.2s;" onmouseover="this.style.color='var(--ifm-color-primary)'" onmouseout="this.style.color='var(--ifm-footer-link-color)'">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
